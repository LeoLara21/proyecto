                  ...
                  <div class="col-lg-6">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Vamos a ayudarte a recuperar tu cuenta</h1>
                      </div>
                      <form name="enviar" class="user" method="post" action ="../controlador/accion/act_recuperarContraseña.php"> <!--Parte donde el usuario coloca su correo electrónico -->
                        <div class="form-group">
                          <input name="email_verificacion" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Ingrese su correo electrónico">
                        </div>                                                
